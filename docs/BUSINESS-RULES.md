...
- The group header carries the **open-task count**: what is visible in the selected week in the Weekly lens, and in the current week everywhere else. The only other numbers on a lens are the ones you wrote down yourself, on a task that carries a measure.
